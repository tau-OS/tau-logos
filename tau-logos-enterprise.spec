...
Provides:   almalinux-logos < %{version}
...
%description
Logos and Anaconda Brand for tauOS Enterprise.
...
Conflicts:  almalinux-logos-httpd
Obsoletes:  generic-logos < 17.0.0-5
BuildArch: noarch

%description httpd
The tau-logos-enterprise-httpd package contains image files which can be used by
httpd.
...
mkdir -p %{buildroot}%{_datadir}/firstboot/themes/tau
for i in firstboot/* ; do
  install -p -m 644 $i %{buildroot}%{_datadir}/firstboot/themes/tau
done
